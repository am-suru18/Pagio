            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
                    <div className="px-4 py-3 border-b border-gray-100">
                        ...
                        <p className="text-xs text-gray-500text-xs text-gray-500text-xs text-gray-500text-xs text-gray-500text-xs text-gray-500text-xs text-gray-500text-xs text-gray-500text-xs text-gray-500text-xs text-gray-500">
                            {email}
                        </p>
                    </div>
