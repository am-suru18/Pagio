...
const BookCard = ({ book, onDelete }) => {
    ...
    return (
        <div
            className="group relative bg-white rounded-xl overflow-hidden border border-gray-100 hover:border-gray-100 transition-all duration-300 hover:shadow-gray-100/50 hover:-translate-y-1 cursor-pointer"
        ...
        >
            ...
            <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-linear-to-br from-orange-500 via-amber-500 to-rose-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        </div>
    );
};
